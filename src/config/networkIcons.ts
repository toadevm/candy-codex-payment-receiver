...
export const NETWORK_ICONS: Record<number, string> = {
  ...
  80094: "/icons/eth.png",    // Berachain (using ETH as placeholder)
  2020: "/icons/ron.png",     // Ronin
  43114: "/icons/avax.png",   // Avalanche
  8453: "/icons/eth.png",     // Base (using ETH as placeholder)
  33139: "/icons/ape.png",    // ApeChain
  1329: "/icons/sei.png",     // Sei
  2741: "/icons/eth.png",     // Abstract (using ETH as placeholder)
